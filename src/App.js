...
const App = () => {
  ...
  const handleSearch = (query) => {          
    ...
    return (
      <div>
        <Router basename='/News-API-React'>
          ...
          <Routes>
            ...
            <Route exact path="/News-API-React" element={<News  setProgress={setProgress}  key="general" pageSize={pageSize} country="us" newsAPI={newsApi} category="general" query={query} />} />
